...
If your organization exceeds the free production limits defined in the Business Source License 1.1 (>$1M annual revenue OR >100GB of processed data/month), you require a commercial production license. 

We map our commercial packages to your organization's operational scale:
...
* **Included Features:**
  ...
  * **Nyxis In-Memory Compactor Daemon** (Advanced log sector defragmentation).
